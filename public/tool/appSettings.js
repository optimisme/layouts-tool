...
let selectableSettings = {
    'align-content': ['initial', 'flex-start', 'center', 'stretch', 'space-between', 'space-around', 'flex-end'],
    'align-self': ['initial', 'auto', 'flex-start', 'center', 'baseline', 'stretch', 'flex-end'],
    'align-items': ['initial', 'flex-start', 'center', 'stretch', 'baseline', 'flex-end'],
    ...
    'justify-content': ['initial', 'flex-start', 'center', 'space-between', 'space-around', 'space-evenly', 'flex-end'],
